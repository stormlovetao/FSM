...
void tree::update_leaf(Leaf * l, int val) {
	l->count += val;
}
...
unsigned long tree::get_leafnum() {
	return leaf_num;
}
...
Leaf* tree::update_one_main(int val) {
	Leaf * leaf;
	if(cur_node->right)
...
Leaf* tree::update_one_rand(int val) {
	Leaf * leaf;
	if(cur_node->right) {
		leaf = (Leaf*)cur_node->right;
		update_leaf(leaf, val);
...
Leaf* tree::update_zero_main(int val) {
	Leaf * leaf;
	if(cur_node->left)
...
Leaf* tree::update_zero_rand(int val) {
	Leaf * leaf;
	if(cur_node->left) {
		leaf = (Leaf*)cur_node->left;
		update_leaf(leaf, val);
